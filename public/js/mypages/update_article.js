                ...
                <div class="col-1">
                    <div class="h-100 w-100 d-flex justify-content-center align-items-center">
                        <label class="custom-radio-box">
                            <input type="radio" name="image_radio" class="image-radio" data-image-id=${data[i].id} ${ $("#selected-image-id-input").val() == data[i].id ? 'checked' : ''}>
        ...
        <div class="playlist-record mt-2 record">
            <div class="row h-100">
                <div class="col-1">
                    <div class="h-100 w-100 d-flex justify-content-center align-items-center">
                        <label class="custom-radio-box">
                            <input type="radio" name="playlist_radio" data-playlist-id=${data[i].id} class="playlist-radio" ${ $("#selected-playlist-id-input").val() == data[i].id ? 'checked' : ''}>
                            <span class="checkmark">
                                <i class="fas fa-check-circle"></i>
                            </span>
                        </label>
            ...
            <div class="singletrack-record mt-2 record">
                <div class="row h-100">
                    <div class="col-1">
                        <div class="h-100 w-100 d-flex justify-content-center align-items-center">
                            <label class="custom-radio-box">
                                <input type="radio" name="singletrack_radio" data-track-id="${data[i].id}" class="singletrack-radio" ${ $("#selected-track-id-input").val() == data[i].id ? 'checked' : ''}>
                                    <span class="checkmark">
                                        <i class="fas fa-check-circle"></i>
                                    </span>
                            </label>
